 ...
 * 最长连续递增序列
 * @author ambrose
 * @date 2024-09-29 20:26:28
 */

public class P0674_LongetContinuouIncreaingSubequence{
	 public static void main(String[] args) {
	 	 //测试代码
	 	 Solution solution = new P0674_LongetContinuouIncreaingSubequence().new Solution();
	 }
