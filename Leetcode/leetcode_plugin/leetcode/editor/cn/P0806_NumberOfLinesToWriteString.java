 ...
 * 写字符串需要的行数
 * @author ambrose
 * @date 2024-10-03 12:13:58
 */

public class P0806_NumberOfLinesToWriteString{
	 public static void main(String[] args) {
	 	 //测试代码
	 	 Solution solution = new P0806_NumberOfLinesToWriteString().new Solution();
	 }
...
//				错误，不该，==100时，不可以换行+改宽度。应该为当前状态考虑而不是，下一步当前行是否有空余。
// 				len = (len + widths[c - 'a']) % 100;
//				row += (len + widths[c - 'a']) / 100;
